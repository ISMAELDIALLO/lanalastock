                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12 col-md-offset-3">
                                    <form action="{{route('detailReception.update',$receptions->slug)}}" method="post">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="quantite" value="{{$receptions->quantite}}" id="quantite">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="prixUnitaire" value="{{$receptions->prixUnitaire}}" id="prixUnitaire">
                                        ...
                                        <div class="row container">
                                            <div class="col-lg-10 col-sm-10 col-md-10">
                                                ...
                                                <div class="col-md-offset-5">
                                                    <a href="{{route('detailReception.index')}}" class="glyphicon glyphicon-arrow-left btn btn-info"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
