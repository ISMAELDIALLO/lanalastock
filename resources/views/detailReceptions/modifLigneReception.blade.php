                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12 col-md-offset-3">
                                    <form action="{{route('temporaireReception.update',$temporaires->id)}}" method="post">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <select name="article" id="article" class="form-control">
                                                    @foreach($articles as $article)
                                                        <option value="{{$article->id}}" @if($article->id == $temporaires->articles) selected @endif>{{$article->referenceArticle}} {{$article->libelleArticle}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="quantite" value="{{$temporaires->quantite}}" id="quantite">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="prixUnitaire" value="{{$temporaires->prixUnitaire}}" id="prixUnitaire">
