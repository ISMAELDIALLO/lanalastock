                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            <h3>Modification de la societe</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-sm-8 col-md-offset-4">
                                    <form action="{{route('societe.update',$societe->slug)}}" method="post">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="col-lg-4 col-md-4 ">
                                            <div class="form-group">
                                                <label for="societe">SOCIETE</label>
                                                <input class="form-control" name="societe" value="{{$societe->nomSociete}}" id="societe">
