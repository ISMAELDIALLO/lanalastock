                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-4 col-md-offset-4">
                                    <form action="{{route('compte.update', $comptes->id)}}" method="post">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <select name="societe" id="societe" class="form-control">
                                                    @foreach($societes as $societe)
                                                        <option value="{{$societe->id}}" @if($societe->id == $comptes->societes_id) selected @endif>{{$societe->nomSociete}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="compte" value="{{ $comptes->compte }}" id="compte">
