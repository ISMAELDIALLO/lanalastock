                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-4 col-md-offset-4">
                                    <form action="{{route('superCategorie.update', $superCategories->slug)}}" method="post">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="superCategorie">SUPER CATEGORIE</label>
                                                <input class="form-control" name="superCategorie" value="{{ $superCategories->superCategorie}}" id="superCategorie">
