                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12 col-md-4 col-md-offset-4">
                                    <form action="{{route('categorieFournisseur.store')}}" method="post">
                                        {{csrf_field()}}
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="categorie">CATEGORIE</label>
                                                <input class="form-control" name="categorie" value="{{ old('categorie') }}" id="categorie">
                                                {!! $errors->first('categorie','<span class="help-block alert-danger">:message</span>') !!}
                                                @if(Session::has('warning'))
                                                    <span class="help-block alert-danger">La categorie du founisseur est unique</span>
                                                    @endif
                                            </div>
                                        </div>
